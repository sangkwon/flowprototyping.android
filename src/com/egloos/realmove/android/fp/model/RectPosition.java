...
import com.egloos.realmove.android.fp.model.Link.Anim;
import com.egloos.realmove.android.fp.model.Link.Event;
...
public class RectPosition implements Serializable {
    ...
    public String toString() {
        return "RectPosition [top=" + top + ", bottom=" + bottom + ", left=" + left + ", right="
                + right + "]";
    }
