...
public abstract class ImageWorker {
	...
	private void runCallback(ImageView imageView, BitmapDrawable value) {
		if (mCallback != null) {
			boolean success = value != null;
			mCallback.onLoadImage(success, imageView, value);
		}
	...
	public interface Callback {
		public void onLoadImage(boolean success, ImageView imageView, BitmapDrawable drawable);
	}
