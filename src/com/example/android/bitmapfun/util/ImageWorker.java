...
public abstract class ImageWorker {
    ...
    private void runCallback(ImageView imageView, Bitmap bitmap) {
        if (mCallback != null) {
            boolean success = bitmap != null;
            mCallback.onLoadImage(success, imageView, bitmap);
        }
    ...
    public void loadImage(Object data, ImageView imageView) {
        ...
        // Logger.i(TAG, "loadImage()", (System.currentTimeMillis() - time), data);
    }
